...
# Output: {"transcoding":true,"version":"v2.11.0"}
...
1. **Never use `build:` in Easy Deploy:** Easy Deploy must exclusively pull official prebuilt images (`tscneo/ace-hls-viewer:2.11.0`).
