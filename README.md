...
*   **⚙️ Configuración Persistente**: (v1.8.1) Configuración del servidor (Bitrates, CRF, Endpoint Público). Sustituye a las variables de entorno para cambios en tiempo de ejecución.
---
